...
class swift():
	...
	def __init__(self):
		...
		self.setpoint = [[0,0,2],[0,0,17],[7,-7,23],[0,-7,23],[-7,-7,23],[-7,0,23],[-7,7,23],[0,7,23],[7,7,23],[0,0,17]] # whycon marker at the position of the dummy given in the scene. Make the whycon marker associated with position_to_hold dummy renderable and make changes accordingly
